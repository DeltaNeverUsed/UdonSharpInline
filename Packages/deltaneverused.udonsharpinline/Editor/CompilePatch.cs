...
namespace UdonSharpInline {
    public static class CompilePatch {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original) {
            ...
            if (injectIndex == -1) {
                Injections.PrintError("Failed to find place to inject syntax rewriter.");
            ...
            var walker = generator.DeclareLocal(typeof(UdonSharpInlineInjector));
            var newroot = generator.DeclareLocal(typeof(UdonSharpInlineInjector));
            ...
            syntaxRebuilder.Add(new(OpCodes.Newobj  , ReflectionHelper.GetConstructor(typeof(UdonSharpInlineInjector), new Type[] { }, BindingFlags.Public | BindingFlags.Instance)));
